...
class ControllerSaleOrder extends Controller {
	...
	public function add() {
		...
		if ($this->validate()) {
			...
			if ($api_info) {
				...
				curl_setopt($curl, CURLOPT_URL, $BASE_URL . 'index.php?route=api/login');
	...
	public function delete() {
		...
		if (isset($this->session->data['cookie'])) {
			...
			curl_setopt($curl, CURLOPT_FORBID_REUSE, false);
			curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
			curl_setopt($curl, CURLOPT_URL, $BASE_URL . 'index.php?route=api/order/delete&order_id=' . $this->request->get['order_id']);
