...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        if (isset($this->request->post['config_url_type'])) {
            $data['config_url_type'] = $this->request->post['config_url_type'];
        } else {
            $data['config_url_type'] = $this->config->get('config_url_type');
        }

        if (isset($this->request->post['store_url_type'])) {
            $data['store_url_type'] = $this->request->post['store_url_type'];
        } else {
            $data['store_url_type'] = $this->config->get('store_url_type');
        }
