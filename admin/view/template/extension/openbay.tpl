...
<div id="content">
  ...
  function version() {
    ...
    setTimeout(function () {
      $.ajax({
        type: 'GET',
        url: BASE_URL + 'index.php?route=extension/openbay/version&token=<?php echo $token; ?>',
        dataType: 'json',
  ...
  function getNotifications() {
    ...
    setTimeout(function () {
      $.ajax({
        type: 'GET',
        url: BASE_URL + 'index.php?route=extension/openbay/notifications&token=<?php echo $token; ?>',
        dataType: 'json',
        success: function (json) {
