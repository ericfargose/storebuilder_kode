      ...
      <div class="panel-body">
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-model"><?php echo $entry_url; ?></label>
                <input type="text" name="filter_url" value="<?php echo $filter_url; ?>" placeholder="<?php echo $entry_url; ?>" id="input-model" class="form-control" />
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <select name="filter_status" id="input-status" class="form-control">
                  ...
                  <option value="active" selected="selected"><?php echo $text_active; ?></option>
                  <?php } else { ?>
                  <option value="active"><?php echo $text_active; ?></option>
                  <?php } ?>
                  <?php if (!$filter_status && !is_null($filter_status)) { ?>
                  <option value="inactive" selected="selected"><?php echo $text_inactive; ?></option>
                  <?php } else { ?>
                  <option value="inactive"><?php echo $text_inactive; ?></option>
                  <?php } ?>
                </select>
              </div>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 's.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 's.url') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'xsm.status') { ?>
...
$('#button-filter').on('click', function() {
  var url = 'index.php?route=mallmanage/stores&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
      url: 'index.php?route=mallmanage/stores/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
      dataType: 'json',
