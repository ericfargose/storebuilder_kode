...
$('#button-filter').bind('click', function() {
  url = BASE_URL + 'index.php?route=openbay/amazonus/bulkListProducts&token=<?php echo $token ?>';
...
$('#button-list').bind('click', function(e) {
  ...
  $.ajax({
    url: BASE_URL + 'index.php?route=openbay/amazonus/doBulkList&token=<?php echo $token ?>',
    data: request_data,
    dataType: 'json',
    type: 'POST',
...
$('#button-search').bind('click', function(e) {
  ...
  if (request_data != '') {
    ...
    $.ajax({
      url: BASE_URL + 'index.php?route=openbay/amazonus/doBulkSearch&token=<?php echo $token ?>',
      data: request_data,
      dataType: 'json',
      type: 'POST',
      beforeSend: function() {
