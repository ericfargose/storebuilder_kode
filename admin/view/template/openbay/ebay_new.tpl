...
<script type="text/javascript"><!--
  ...
  function getSuggestedCategories() {
        var qry = $('#name').val();
        $.ajax({
            url: BASE_URL + 'index.php?route=openbay/ebay/getSuggestedCategories&token=<?php echo $token; ?>&qry='+qry,
            type: 'GET',
            dataType: 'json',
            beforeSend: function() {
  ...
  function loadCategories(level, skip) {
        ...
        $.ajax({
            url: BASE_URL + 'index.php?route=openbay/ebay/getCategories&token=<?php echo $token; ?>&parent='+parent,
            type: 'POST',
            dataType: 'json',
            beforeSend: function() {
  ...
  function getCategoryFeatures(cat) {
        ...
        $.ajax({
            url: BASE_URL + 'index.php?route=openbay/ebay/getCategoryFeatures&token=<?php echo $token; ?>&category='+cat,
            type: 'GET',
            dataType: 'json',
            success: function(data) {
                if (data.error == false) {
  ...
  $('#button-catalog-search').bind('click', function() {
        ...
        $.ajax({
            url: BASE_URL + 'index.php?route=openbay/ebay/searchEbayCatalog&token=<?php echo $token; ?>',
            type: 'POST',
            dataType: 'json',
  ...
  function itemFeatures(cat) {
        $.ajax({
            url: BASE_URL + 'index.php?route=openbay/ebay/getEbayCategorySpecifics&token=<?php echo $token; ?>&category='+cat,
            type: 'GET',
            dataType: 'json',
            beforeSend: function() {
  ...
  function profileShippingUpdate() {
    if ($('#profile-shipping-input').val() != 'def') {
      ...
      $.ajax({
        type:'GET',
        dataType: 'json',
        url: BASE_URL + 'index.php?route=openbay/ebay_profile/profileGet&token=<?php echo $token; ?>&ebay_profile_id='+$('#profile-shipping-input').val(),
        success: function(data) {
          setTimeout(function() {
  ...
  $.ajax({
    url: BASE_URL + 'index.php?route=openbay/ebay/getShippingService&token=<?php echo $token; ?>&loc=' + loc + '&type=' + type,
    beforeSend: function(){
  ...
  $('#button-verify').bind('click', function() {
    ...
    if (err == 0) {
        $.ajax({
            type:'POST',
            dataType: 'json',
            url: BASE_URL + 'index.php?route=openbay/ebay/verify&token=<?php echo $token; ?>&options='+hasOptions,
            data: $("#form").serialize(),
            beforeSend: function() {
              $('#button-save').hide();
              $('#button-preview').hide();
  ...
  $('#button-save').bind('click', function() {
      ...
      $.ajax({
        type:'POST',
        dataType: 'json',
        url: BASE_URL + 'index.php?route=openbay/ebay/listItem&token=<?php echo $token; ?>&options='+hasOptions,
        data: $("#form").serialize(),
        beforeSend: function() {
      ...
      if ($('#profile-return-input').val() != 'def') {
        ...
        $('#profile-return-input').attr('disabled', 'disabled');
          ...
          $.ajax({
              type:'GET',
              dataType: 'json',
              url: BASE_URL + 'index.php?route=openbay/ebay_profile/profileGet&token=<?php echo $token; ?>&ebay_profile_id='+$('#profile-return-input').val(),
              success: function(data) {
                  setTimeout(function() {
  ...
  if ($('#profile-theme-input').val() != 'def') {
      ...
      $.ajax({
          type:'GET',
          dataType: 'json',
          url: BASE_URL + 'index.php?route=openbay/ebay_profile/profileGet&token=<?php echo $token; ?>&ebay_profile_id='+$('#profile-theme-input').val(),
          success: function(data) {
              setTimeout(function() {
  ...
  function profileGenericUpdate() {
      if ($('#profile-generic-input').val() != 'def') {
          ...
          $.ajax({
              type:'GET',
              dataType: 'json',
              url: BASE_URL + 'index.php?route=openbay/ebay_profile/profileGet&token=<?php echo $token; ?>&ebay_profile_id='+$('#profile-generic-input').val(),
              success: function(data) {
                  setTimeout(function() {
