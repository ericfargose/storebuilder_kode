...
<script type="text/javascript">
  ...
  function modifyPrices(id) {
      ...
      $.ajax({
          url: BASE_URL + 'index.php?route=openbay/ebay_profile/profileGet&token=<?php echo $token; ?>&ebay_profile_id='+$('#generic_profile_'+id).val(),
          type: 'GET',
          async: true,
          dataType: 'json',
  ...
  $('#button-verify').bind('click', function() {
      ...
      $.each($('.product_id'), function(i) {
          ...
          $.ajax({
              url: BASE_URL + 'index.php?route=openbay/ebay/verifyBulk&token=<?php echo $token; ?>&i='+id,
              type: 'POST',
              dataType: 'json',
              data: processedData,
              beforeSend: function() { addCount(); },
  ...
  $('#button-submit').bind('click', function() {
      ...
      if (confirm_box) {
          ...
          $.each($('.product_id'), function(i) {
              ...
              $.ajax({
                url: BASE_URL + 'index.php?route=openbay/ebay/listItemBulk&token=<?php echo $token; ?>&i='+id,
                type: 'POST',
                dataType: 'json',
