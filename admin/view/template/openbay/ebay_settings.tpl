...
<script type="text/javascript"><!--
    $('#button-clear-locks').bind('click', function() {
      $.ajax({
        url: BASE_URL + 'index.php?route=openbay/ebay/deleteAllLocks&token=<?php echo $token; ?>',
        type: 'post',
        dataType: 'json',
        beforeSend: function() {
    ...
    $('#button-repair-links').bind('click', function() {
      $.ajax({
        url: BASE_URL + 'index.php?route=openbay/ebay/repairLinks&token=<?php echo $token; ?>',
        type: 'post',
        dataType: 'json',
        beforeSend: function() {
    ...
    function checkCredentials() {
        $.ajax({
            url: BASE_URL + 'index.php?route=openbay/ebay/verifyCreds&token=<?php echo $token; ?>',
            type: 'POST',
            dataType: 'json',
