...
<script type="text/javascript"><!--
  ...
  function submitForm() {
    $.ajax({
      url: BASE_URL + 'index.php?route=openbay/etsy_product/createsubmit&token=<?php echo $token; ?>',
      beforeSend: function(){
  ...
  function uploadImage(listing_id, url, id) {
    $.ajax({
      url: BASE_URL + 'index.php?route=openbay/etsy_product/addimage&token=<?php echo $token; ?>',
      beforeSend: function(){
  ...
  $('#input-category').on('change', function() {
    $.ajax({
      url: BASE_URL + 'index.php?route=openbay/etsy_product/getsubcategory&token=<?php echo $token; ?>',
      beforeSend: function(){
  ...
  $('#input-sub-category').on('change', function() {
    ...
    $.ajax({
      url: BASE_URL + 'index.php?route=openbay/etsy_product/getsubsubcategory&token=<?php echo $token; ?>',
      beforeSend: function(){
        $('#input-category').attr('disabled','disabled');
  ...
  function getCategory(tag) {
    $.ajax({
      url: BASE_URL + 'index.php?route=openbay/etsy_product/getcategory&token=<?php echo $token; ?>',
      beforeSend: function(){ },
      type: 'post',
      data: {'tag' : tag},
      dataType: 'json',
  ...
  function getShippingProfiles() {
    $.ajax({
      url: BASE_URL + 'index.php?route=openbay/etsy_shipping/getall&token=<?php echo $token; ?>',
      beforeSend: function(){
  ...
  function getShopSection() {
    $.ajax({
      url: BASE_URL + 'index.php?route=openbay/etsy_shop/getsections&token=<?php echo $token; ?>',
      beforeSend: function(){
