...
<script type="text/javascript"><!--
  function filter() {
      url = BASE_URL + 'index.php?route=extension/openbay/items&token=<?php echo $token; ?>';
  ...
  $('#button-ebay-bulk').bind('click', function() {
    ...
    if (request_data != '') {
      $('#form').attr('action', BASE_URL + 'index.php?route=openbay/ebay/createBulk&token=<?php echo $token; ?>').submit();
    } else {
