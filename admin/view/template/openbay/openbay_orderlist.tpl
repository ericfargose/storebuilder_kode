...
<script type="text/javascript"><!--
  function filter() {
    url = BASE_URL + 'index.php?route=extension/openbay/orderList&token=<?php echo $token; ?>';
...
<script type="text/javascript"><!--
    ...
    $('input[name=\'filter_customer\']').catcomplete({
        ...
        source: function(request, response) {
            $.ajax({
                url: BASE_URL + 'index.php?route=sale/customer/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
                dataType: 'json',
