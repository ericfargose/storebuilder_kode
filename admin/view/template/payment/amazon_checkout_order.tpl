...
$('#button-upload').on('click', function() {
	...
	timer = setInterval(function() {
		if ($('#form-upload input[name=\'file\']').val() != '') {
			...
			$.ajax({
				url: BASE_URL + 'index.php?route=payment/amazon_checkout/uploadOrderAdjustment&token=<?php echo $token; ?>',
				type: 'post',
				dataType: 'json',
				...
				success: function(json) {
					...
					if (json['success']) {
						...
						$.get(BASE_URL + 'index.php?route=payment/amazon_checkout/addSubmission&order_id=<?php echo $order_id ?>&submission_id=' + json['submission_id'] + '&token=<?php echo $token; ?>');
					}
