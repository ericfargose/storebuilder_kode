...
<script type="text/javascript">
	function downloadTransactions() {
		...
		$('#transaction-form').attr('action', BASE_URL + 'index.php?route=payment/securetrading_ws/downloadTransactions&token=<?php echo $token ?>');
	...
	function showTransactions() {
		$.ajax({
			url: BASE_URL + 'index.php?route=payment/securetrading_ws/showTransactions&token=<?php echo $token ?>',
			type: 'post',
