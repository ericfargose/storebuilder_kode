...
$('#button-filter').on('click', function() {
	url = BASE_URL + 'index.php?route=sale/customer&token=<?php echo $token; ?>';
...
$('input[name=\'filter_email\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: BASE_URL + 'index.php?route=sale/customer/autocomplete&token=<?php echo $token; ?>&filter_email=' +  encodeURIComponent(request),
			dataType: 'json',			
			success: function(json) {
				response($.map(json, function(item) {
					return {
