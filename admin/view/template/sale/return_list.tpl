...
$('#button-filter').on('click', function() {
	url = BASE_URL + 'index.php?route=sale/return&token=<?php echo $token; ?>';
...
$('input[name=\'filter_model\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: BASE_URL + 'index.php?route=catalog/product/autocomplete&token=<?php echo $token; ?>&filter_model=' +  encodeURIComponent(request),
			dataType: 'json',			
			success: function(json) {
				response($.map(json, function(item) {
					return {
