...
$('#button-send').on('click', function() {
	$.ajax({
		url: BASE_URL + 'index.php?route=sale/voucher/send&token=<?php echo $token; ?>',
		type: 'post',
		dataType: 'json',
...
$('#history').load(BASE_URL + 'index.php?route=sale/voucher/history&token=<?php echo $token; ?>&voucher_id=<?php echo $voucher_id; ?>');
//--></script>
  <?php } ?>
</div>
<?php echo $footer; ?>