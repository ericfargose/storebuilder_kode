            ...
            <div class="tab-pane active" id="tab-general">
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  ...
                  <input type="hidden" name="config_url" value="<?php echo $config_url; ?>" id="input-url" />
                  <input type="hidden" name="config_ssl" value="<?php echo $config_ssl; ?>" id="input-ssl" />
                  <input type="hidden" name="config_url_type" value="<?php echo $config_url_type; ?>" id="input-urltype" />
                  <input type="hidden" name="store_url_type" value="<?php echo $store_url_type; ?>" id="input-storeurltype" />
                  <?php if ($error_name) { ?>
...
$('select[name=\'config_template\']').on('change', function() {
	$.ajax({
		url: BASE_URL + 'index.php?route=setting/setting/template&token=<?php echo $token; ?>&template=' + encodeURIComponent(this.value),
		dataType: 'html',
		beforeSend: function() {
...
$('select[name=\'config_country_id\']').on('change', function() {
	$.ajax({
		url: BASE_URL + 'index.php?route=setting/setting/country&token=<?php echo $token; ?>&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
