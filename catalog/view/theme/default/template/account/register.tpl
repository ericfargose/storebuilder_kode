...
$('input[name=\'customer_group_id\']').on('change', function() {
	$.ajax({
		url: BASE_URL + 'index.php?route=account/register/customfield&customer_group_id=' + this.value,
		dataType: 'json',
...
$('select[name=\'country_id\']').on('change', function() {
	$.ajax({
		url: BASE_URL + 'index.php?route=account/account/country&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
