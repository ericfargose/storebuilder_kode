...
$('#button-quote').on('click', function() {
	$.ajax({
		url: BASE_URL + 'index.php?route=checkout/shipping/quote',
		type: 'post',
...
$(document).delegate('#button-shipping', 'click', function() {
	$.ajax({
		url: BASE_URL + 'index.php?route=checkout/shipping/shipping',
		type: 'post',
...
$('select[name=\'country_id\']').on('change', function() {
	$.ajax({
		url: BASE_URL + 'index.php?route=checkout/shipping/country&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
