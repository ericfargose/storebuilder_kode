...
$('#review').load(BASE_URL + 'index.php?route=product/product/review&product_id=<?php echo $product_id; ?>');

$('#button-review').on('click', function() {
	$.ajax({
		url: BASE_URL + 'index.php?route=product/product/write&product_id=<?php echo $product_id; ?>',
		type: 'post',
		dataType: 'json',
		...
		complete: function() {
			...
			$('#captcha').attr('src', BASE_URL + 'index.php?route=tool/captcha#'+new Date().getTime());
