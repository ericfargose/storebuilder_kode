...
--
-- Host: localhost
-- Generation Time: Apr 06, 2015 at 12:52 PM
...
(1, 'KEgiWAUGCLS6PgaMF53koTp4rp0GFPhQTEyqEIwHTFDimevrZpSD878qmyxsEV8X', '', '', '', 1, '2015-03-10 16:44:25', '2015-03-10 16:44:25');
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.67019999, 1, '2015-04-04 05:19:44'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2015-04-04 11:08:14'),
(3, 'Euro', 'EUR', '', '€', '2', 0.91790003, 1, '2015-04-04 05:19:44');
...
--
-- Table structure for table `sb_store`
--

CREATE TABLE IF NOT EXISTS `sb_store` (
  ...
  `db_name` varchar(255) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`store_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=2 ;

--
-- Dumping data for table `sb_store`
--

INSERT INTO `sb_store` (`store_id`, `name`, `url`, `email`, `username`, `password`, `db_name`) VALUES
(1, 'storebuilder', 'http://storebuilder.kp/', 'aaron@kodeplay.com', 'admin', 'admin', 'storebuilder');

-- --------------------------------------------------------

--
-- Table structure for table `sb_xstore_meta`
--

CREATE TABLE IF NOT EXISTS `sb_xstore_meta` (
  `store_id` int(11) NOT NULL,
  `status` enum('active','renewal pending','banned','disabled') NOT NULL,
  `domain` varchar(45) NOT NULL,
  `url_mode` varchar(16) NOT NULL,
...
(377, 0, 'config', 'config_mail_alert', '', 0),
(378, 0, 'config', 'config_fraud_detection', '0', 0),
(379, 0, 'config', 'config_fraud_key', '', 0),
(380, 0, 'config', 'config_fraud_score', '', 0),
(381, 0, 'config', 'config_fraud_status_id', '7', 0),
(382, 0, 'config', 'config_secure', '0', 0),
(383, 0, 'config', 'config_shared', '0', 0),
(384, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai''hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
(376, 0, 'config', 'config_mail', 'a:7:{s:8:"protocol";s:4:"mail";s:9:"parameter";s:0:"";s:13:"smtp_hostname";s:0:"";s:13:"smtp_username";s:0:"";s:13:"smtp_password";s:0:"";s:9:"smtp_port";s:0:"";s:12:"smtp_timeout";s:0:"";}', 1),
(375, 0, 'config', 'config_ftp_status', '0', 0),
(94, 0, 'voucher', 'voucher_sort_order', '8', 0),
(95, 0, 'voucher', 'voucher_status', '1', 0),
(374, 0, 'config', 'config_ftp_root', '', 0),
(373, 0, 'config', 'config_ftp_password', '', 0),
(103, 0, 'free_checkout', 'free_checkout_status', '1', 0),
(104, 0, 'free_checkout', 'free_checkout_order_status_id', '1', 0),
(369, 0, 'config', 'config_image_location_height', '50', 0),
(370, 0, 'config', 'config_ftp_hostname', 'storebuilder.kp', 0),
(371, 0, 'config', 'config_ftp_port', '21', 0),
(372, 0, 'config', 'config_ftp_username', '', 0),
(368, 0, 'config', 'config_image_location_width', '268', 0),
(367, 0, 'config', 'config_image_cart_height', '47', 0),
(366, 0, 'config', 'config_image_cart_width', '47', 0),
(365, 0, 'config', 'config_image_wishlist_height', '47', 0),
(364, 0, 'config', 'config_image_wishlist_width', '47', 0),
(363, 0, 'config', 'config_image_compare_height', '90', 0),
(362, 0, 'config', 'config_image_compare_width', '90', 0),
(361, 0, 'config', 'config_image_related_height', '80', 0),
(360, 0, 'config', 'config_image_related_width', '80', 0),
(359, 0, 'config', 'config_image_additional_height', '74', 0),
(358, 0, 'config', 'config_image_additional_width', '74', 0),
(357, 0, 'config', 'config_image_product_height', '228', 0),
(356, 0, 'config', 'config_image_product_width', '228', 0),
(355, 0, 'config', 'config_image_popup_height', '500', 0),
(354, 0, 'config', 'config_image_popup_width', '500', 0),
(353, 0, 'config', 'config_image_thumb_height', '228', 0),
(352, 0, 'config', 'config_image_thumb_width', '228', 0),
(351, 0, 'config', 'config_image_category_height', '80', 0),
(350, 0, 'config', 'config_image_category_width', '80', 0),
...
(337, 0, 'config', 'config_order_mail', '0', 0),
(336, 0, 'config', 'config_complete_status', 'a:1:{i:0;s:1:"5";}', 1),
(335, 0, 'config', 'config_processing_status', 'a:1:{i:0;s:1:"2";}', 1),
...
(330, 0, 'config', 'config_api_id', '1', 0),
(329, 0, 'config', 'config_invoice_prefix', 'INV-2013-00', 0),
(328, 0, 'config', 'config_account_mail', '0', 0),
(327, 0, 'config', 'config_account_id', '3', 0),
(326, 0, 'config', 'config_login_attempts', '5', 0),
(325, 0, 'config', 'config_customer_price', '0', 0),
(324, 0, 'config', 'config_customer_group_display', 'a:1:{i:0;s:1:"1";}', 1),
...
(316, 0, 'config', 'config_review_mail', '0', 0),
(315, 0, 'config', 'config_review_guest', '1', 0),
(314, 0, 'config', 'config_review_status', '1', 0),
(313, 0, 'config', 'config_limit_admin', '20', 0),
(312, 0, 'config', 'config_product_description_length', '100', 0),
(311, 0, 'config', 'config_product_limit', '15', 0),
(310, 0, 'config', 'config_product_count', '1', 0),
(309, 0, 'config', 'config_weight_class_id', '1', 0),
(308, 0, 'config', 'config_length_class_id', '1', 0),
(307, 0, 'config', 'config_currency_auto', '1', 0),
(306, 0, 'config', 'config_currency', 'USD', 0),
(305, 0, 'config', 'config_admin_language', 'en', 0),
(301, 0, 'config', 'config_layout_id', '4', 0),
(302, 0, 'config', 'config_country_id', '99', 0),
(303, 0, 'config', 'config_zone_id', '1493', 0),
(304, 0, 'config', 'config_language', 'en', 0),
(291, 0, 'config', 'config_email', 'aaron@kodeplay.com', 0),
(292, 0, 'config', 'config_telephone', '123456789', 0),
(293, 0, 'config', 'config_fax', '', 0),
(294, 0, 'config', 'config_image', '', 0),
(295, 0, 'config', 'config_open', '', 0),
(296, 0, 'config', 'config_comment', '', 0),
(297, 0, 'config', 'config_meta_title', 'Store Builder', 0),
(298, 0, 'config', 'config_meta_description', 'Store Builder', 0),
(299, 0, 'config', 'config_meta_keyword', 'Store Builder', 0),
(300, 0, 'config', 'config_template', 'default', 0),
(290, 0, 'config', 'config_geocode', '', 0),
(289, 0, 'config', 'config_address', 'Address 1', 0),
(288, 0, 'config', 'config_owner', 'Aaron Fargose', 0),
(287, 0, 'config', 'config_url_type', '', 0),
(286, 0, 'config', 'config_ssl', 'https://storebuilder.kp/', 0),
(285, 0, 'config', 'config_url', 'http://storebuilder.kp/', 0),
(284, 0, 'config', 'config_name', 'Store Builder', 0),
(385, 0, 'config', 'config_seo_url', '0', 0),
(386, 0, 'config', 'config_file_max_size', '300000', 0),
(387, 0, 'config', 'config_file_ext_allowed', 'txt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc\r\nrtf\r\nxls\r\nppt\r\nodt\r\nods', 0),
(388, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/vnd.microsoft.icon\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\napplication/x-rar-compressed\r\napplication/x-msdownload\r\napplication/vnd.ms-cab-compressed\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf\r\nimage/vnd.adobe.photoshop\r\napplication/postscript\r\napplication/msword\r\napplication/rtf\r\napplication/vnd.ms-excel\r\napplication/vnd.ms-powerpoint\r\napplication/vnd.oasis.opendocument.text\r\napplication/vnd.oasis.opendocument.spreadsheet', 0),
(389, 0, 'config', 'config_maintenance', '0', 0),
(390, 0, 'config', 'config_password', '1', 0),
(391, 0, 'config', 'config_encryption', '06316812dcdbd9e5097326146cfa8a4e', 0),
(392, 0, 'config', 'config_compression', '0', 0),
(393, 0, 'config', 'config_error_display', '1', 0),
(394, 0, 'config', 'config_error_log', '1', 0),
(395, 0, 'config', 'config_error_filename', 'error.log', 0),
(396, 0, 'config', 'config_google_analytics', '', 0);
...
(1, 1, 'admin', '3c6cb5d1a8ad33b06b16bdabf098d976fb03dcac', '68002e976', 'Aaron', 'Fargose', 'aaron@kodeplay.com', '', '', '127.0.0.1', 1, '2015-03-10 16:44:25');
